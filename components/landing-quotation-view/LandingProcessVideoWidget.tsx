...
interface LandingProcessVideoWidgetProps {
...
const LandingProcessVideoWidget: React.FC<LandingProcessVideoWidgetProps> = ({
  standardContent,
  theme: themeProps
}) => {
    ...
    if (!videoInfo) {
      return (
        <div style={{
          ...
          <VideoCameraOutlined style={{ fontSize: '64px', color: primaryColor, marginBottom: '20px' }} />
      ...
      <Space direction="vertical" style={{ width: '100%' }} size="large">
        <div style={{ textAlign: 'center' }}>
          <Space align="center" size="small">
            <PlayCircleOutlined style={{ fontSize: '24px', color: primaryColor }} />
            <Title level={3} style={{ margin: 0, color: primaryColor }}>
              Process Video
            </Title>
          </Space>
          <Text type="secondary" style={{ display: 'block', marginTop: '12px', fontSize: '16px' }}>
...
export default LandingProcessVideoWidget;
